package com.superstrona.a20241211;
...
public class LoggedFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        assert args != null;
        ((TextView) view.findViewById(R.id.resname)).setText(Objects.requireNonNull(args.get("resname")).toString());
        ((TextView) view.findViewById(R.id.ressurname)).setText(Objects.requireNonNull(args.get("ressurname")).toString());
        ((TextView) view.findViewById(R.id.resemail)).setText(Objects.requireNonNull(args.get("resemail")).toString());
        return view;
    }
}